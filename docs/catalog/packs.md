...
| --- | --- | --- | --- | --- | --- | --- |
| [issue-driven-os-core](../../packs/issue-driven-os-core/README.md) | agent-team | 0.1.0 | experimental | workflow, coding, review, productivity | 6 skills, 5 agents | Core intake, shaping, execution, and critique team for the Issue-Driven Agent OS implementation path. |
