...
| [issue-solver](../../agents/issue-solver/codex.toml) | 0.2.2 | experimental | custom | codex | workflow, coding | Solves a single GitHub issue end-to-end by orchestrating specialist agents through triage, implementation, review, and merge. |
