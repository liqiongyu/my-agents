...
| [issue-solver](../../agents/issue-solver/codex.toml) | 0.1.0 | experimental | custom | codex | workflow, coding | Single-issue Codex-native orchestrator that drives one GitHub issue for the current project's GitHub remote from intake through triage, execution, review, and terminal resolution. |
