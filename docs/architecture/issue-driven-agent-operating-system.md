...
### 7.3 完整目标架构中的 Reference Agent Families

本章前面定义的是边界规则。
但完整目标架构仍然必须明确回答一件事：
**最终整套系统原则上要具备哪些 agent families。**
...
| Shaping / decomposition | `Shaper / Decomposer`              | issue-graph related shaping service     | `issue-shaping`, `decomposition-planning`                               |
...
### 9.12 完整目标架构中的 Reference Service Families
...
### 9.13 Reference Assembly Patterns
